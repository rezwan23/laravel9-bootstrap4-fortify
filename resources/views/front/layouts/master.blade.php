...
<head>
   ...
   <title>Halal & Healthy</title>
   <meta name="description" content="">
   <meta name="viewport" content="width=device-width, initial-scale=1">

   <!-- Place favicon.ico in the root directory -->
   <link rel="shortcut icon" type="image/x-icon" href="/front/assets/imgs/grocery/favicon.png">
   ...
   <link rel="stylesheet" href="/front/assets/css/fontawesome-pro.css">
   <link rel="stylesheet" href="/front/assets/css/spacing.css">
   <link rel="stylesheet" href="/front/assets/css/grocery.css">
</head>
            ...
            <div class="offcanvas__content">
               <div class="offcanvas__top mb-40 d-flex justify-content-between align-items-center">
                  <div class="offcanvas__logo">
                     <a href="">
                        <img src="/front/assets/imgs/logo.png" alt="logo not found">
                     </a>
                  </div>
               ...
               <div class="offcanvas__contact mt-30 mb-20">
                  ...
                  <ul>
                     ...
                     <li class="d-flex align-items-center">
                        ...
                        <div class="offcanvas__contact-text">
                           <a class="grocery-clr-hover" href="tel:+8801711952409">+8801711952409</a>
                        </div>
                     </li>
                     <li class="d-flex align-items-center">
                        <div class="offcanvas__contact-icon mr-15">
                        ...
                        <div class="offcanvas__contact-text">
                           <a class="grocery-clr-hover" href="tel:+012-345-6789"><span
                                 class="mailto:hello@halanandhealthy.com">hello@halanandhealthy.com</span></a>
                        </div>
                     </li>
                  </ul>
               </div>
                                    ...
                                    <nav>
                                       <div class="nav nav-tabs flex-nowrap flex-sm-column" id="nav-tab" role="tablist">
                                          <button class="nav-link active" id="img-1-tab" data-bs-toggle="tab"
                                             ...
                                             aria-selected="true">
                                             <img src="/front/assets/imgs/product/details/details-07.png"
                                    ...
                                    <div class="tab-content" id="productthumbcontent">
                                       <div class="tab-pane fade show active" id="img-1" role="tabpanel"
                                          ...
                                          <div class="product__details-thumb-big w-img">
                                             <img src="/front/assets/imgs/product/details/details-07.png" alt="">
                                          </div>
                                       </div>
                                       <div class="tab-pane fade" id="img-2" role="tabpanel"
                                          aria-labelledby="img-2-tab">
                                          <div class="product__details-thumb-big w-img">
                                             <img src="/front/assets/imgs/product/details/details-08.png" alt="">
                                          </div>
                                       </div>
                                       <div class="tab-pane fade" id="img-3" role="tabpanel"
                                          aria-labelledby="img-3-tab">
                                          <div class="product__details-thumb-big w-img">
                                             <img src="/front/assets/imgs/product/details/details-09.png" alt="">
                                          </div>
                                       </div>
                                    </div>
                                 </div>
            ...
            <div class="header-layout-4">
               <div class="header-to-main d-none d-sm-flex">
                  <div class="link-text">
                     ...
                     <a href="tel:+8801711952409">+8801711952409</a>
                  </div>
                  ...
                  <div class="tp-header-top-menu d-flex align-items-center justify-content-end">
                     ...
                     <div class="header-lang-item tp-header-setting">
                        ...
                        <ul>
                           ...
                           <li>
                              <a class="grocery-clr-hover" href="">Wishlist</a>
                           </li>
                           <li>
                              <a class="grocery-clr-hover" href="">Cart</a>
                           </li>
                           <li>
                  ...
                  <div class="header-main-4">
                     ...
                     <div class="header-right d-inline-flex align-items-center justify-content-end">
                        ...
                        <div class="header-action d-flex align-items-center ml-30">
                           ...
                           <div class="header-action-item">
                              <a href="#" class="header-action-btn cartmini-open-btn">
   ...
   <main>
                           ...
                           <div class="col-xxl-6 col-lg-6">
                              <div class="banner-content-4 grocery__content">
                                 ...
                                 <div class="banner-btn-wrapper grocery__btn-group mt-50">
                                    <a class="solid-btn" href="#">Buy Now<span><i
                           ...
                           <div class="col-xxl-6 col-lg-6">
                              <div class="banner-thumb-wrapper-4 p-relative">
                                 <div class="banner-thumb-4">
                                    <img src="/front/assets/imgs/grocery/banner/product1.png" alt="image">
                                 </div>
                                 <div class="banner-discout-tag">
                                    <img src="/front/assets/imgs/grocery/banner/discount-tag.png" alt="">
                                 </div>
                              </div>
                           </div>
                        </div>
                     ...
                     <div class="container">
                        <div class="row g-5 align-self-center">
                           ...
                           <div class="col-xxl-6 col-lg-6">
                              <div class="banner-thumb-wrapper-4 p-relative">
                                 <div class="banner-thumb-4">
                                    <img src="/front/assets/imgs/grocery/banner/product2.png" alt="image">
                                 </div>
                                 <div class="banner-discout-tag">
                                    <img src="/front/assets/imgs/grocery/banner/discount-tag.png" alt="">
                                 </div>
                     ...
                     <div class="container">
                        <div class="row g-5 align-self-center">
                           ...
                           <div class="col-xxl-6 col-lg-6">
                              <div class="banner-thumb-wrapper-4 p-relative">
                                 <div class="banner-thumb-4">
                                    <img src="/front/assets/imgs/grocery/banner/product3.png" alt="image">
                                 </div>
                                 <div class="banner-discout-tag">
                                    <img src="/front/assets/imgs/grocery/banner/discount-tag.png" alt="">
                                 </div>
                        ...
                        <div class="swiper-wrapper">
                           <div class="swiper-slide">
                              <div class="grocery-category__item">
                                 <div class="icon">
                                    <img src="/front/assets/imgs/grocery/icon/category-01.png" alt="icon">
                                 </div>
                                 <h6>
                                    <a href="#">Vegetable</a>
                                 </h6>
                           ...
                           <div class="swiper-slide">
                              <div class="grocery-category__item">
                                 <div class="icon">
                                    <img src="/front/assets/imgs/grocery/icon/category-02.png" alt="icon">
                                 </div>
                                 <h6>
                                    <a href="#">Milk & dairy</a>
                                 </h6>
                           ...
                           <div class="swiper-slide">
                              <div class="grocery-category__item">
                                 <div class="icon">
                                    <img src="/front/assets/imgs/grocery/icon/category-03.png" alt="icon">
                                 </div>
                                 <h6>
                                    <a href="#">Coffee & Tea</a>
                                 </h6>
                           ...
                           <div class="swiper-slide">
                              <div class="grocery-category__item">
                                 <div class="icon">
                                    <img src="/front/assets/imgs/grocery/icon/category-04.png" alt="icon">
                                 </div>
                                 <h6>
                                    <a href="#">Drinks</a>
                                 </h6>
                           ...
                           <div class="swiper-slide">
                              <div class="grocery-category__item">
                                 <div class="icon">
                                    <img src="/front/assets/imgs/grocery/icon/category-05.png" alt="icon">
                                 </div>
                                 <h6>
                                    <a href="#">Meat</a>
                                 </h6>
                           ...
                           <div class="swiper-slide">
                              <div class="grocery-category__item">
                                 <div class="icon">
                                    <img src="/front/assets/imgs/grocery/icon/category-06.png" alt="icon">
                                 </div>
                                 <h6>
                  ...
                  <div class="tab-pane fade active show" id="collection" role="tabpanel"
                     ...
                     <div class="row g-4">
                        <div class="col-xxl-3 col-lg-3 col-md-4 col-sm-6 col-6">
                           <div class="product-item grocery__product">
                              ...
                              <div class="product-thumb theme-bg-2">
                                 <a href="#"><img src="/front/assets/imgs/grocery/product/product1.png"
                                       alt=""></a>
                              ...
                              <div class="product-content">
                                 <h4 class="product-title"><a href="#">Organic Avocado</a></h4>
                        ...
                        <div class="col-xxl-3 col-lg-3 col-md-4 col-sm-6 col-6">
                           <div class="product-item grocery__product">
                              <div class="product-thumb theme-bg-2">
                                 <a href="#"><img src="/front/assets/imgs/grocery/product/product2.png"
                                       alt=""></a>
                                 <div class="product-action-item">
                                    <button type="button" class="product-action-btn">
                                       <svg width="20" height="22" viewBox="0 0 20 22" fill="none"
                              ...
                              <div class="product-content">
                                 <h4 class="product-title"><a href="#">Cheddar Fries</a></h4>
                                 <div class="user-rating mb-1">
                                    <i class="far fa-star"></i>
                                    <i class="far fa-star"></i>
                                    <i class="far fa-star"></i>
                        ...
                        <div class="col-xxl-3 col-lg-3 col-md-4 col-sm-6 col-6">
                           <div class="product-item grocery__product">
                              ...
                              <div class="product-thumb theme-bg-2">
                                 <a href="#"><img src="/front/assets/imgs/grocery/product/product3.png"
                                       alt=""></a>
                                 <div class="product-action-item">
                                    <button type="button" class="product-action-btn">
                                       <svg width="20" height="22" viewBox="0 0 20 22" fill="none"
                              ...
                              <div class="product-content">
                                 <h4 class="product-title"><a href="#">Broccoli Organic</a></h4>
                                 <div class="user-rating mb-1">
                                    <i class="far fa-star"></i>
                                    <i class="far fa-star"></i>
                                    <i class="far fa-star"></i>
                        ...
                        <div class="col-xxl-3 col-lg-3 col-md-4 col-sm-6 col-6">
                           <div class="product-item grocery__product">
                              <div class="product-thumb theme-bg-2">
                                 <a href="#"><img src="/front/assets/imgs/grocery/product/product4.png"
                                       alt=""></a>
                                 <div class="product-action-item">
                                    <button type="button" class="product-action-btn">
                                       <svg width="20" height="22" viewBox="0 0 20 22" fill="none"
                              ...
                              <div class="product-content">
                                 <h4 class="product-title"><a href="#">Broccoli Farms</a></h4>
                                 <div class="user-rating mb-1">
                                    <i class="far fa-star"></i>
                                    <i class="far fa-star"></i>
                                    <i class="far fa-star"></i>
                        ...
                        <div class="col-xxl-3 col-lg-3 col-md-4 col-sm-6 col-6">
                           <div class="product-item grocery__product">
                              ...
                              <div class="product-thumb theme-bg-2">
                                 <a href="#"><img src="/front/assets/imgs/grocery/product/product5.png"
                                       alt=""></a>
                                 <div class="product-action-item">
                                    <button type="button" class="product-action-btn">
                                       <svg width="20" height="22" viewBox="0 0 20 22" fill="none"
                              ...
                              <div class="product-content">
                                 <h4 class="product-title"><a href="#">Fresh Orange</a></h4>
                                 <div class="user-rating mb-1">
                                    <i class="far fa-star"></i>
                                    <i class="far fa-star"></i>
                                    <i class="far fa-star"></i>
                        ...
                        <div class="col-xxl-3 col-lg-3 col-md-4 col-sm-6 col-6">
                           <div class="product-item grocery__product">
                              <div class="product-thumb theme-bg-2">
                                 <a href="#"><img src="/front/assets/imgs/grocery/product/product6.png"
                                       alt=""></a>
                                 <div class="product-action-item">
                                    <button type="button" class="product-action-btn">
                                       <svg width="20" height="22" viewBox="0 0 20 22" fill="none"
                        ...
                        <div class="col-xxl-3 col-lg-3 col-md-4 col-sm-6 col-6">
                           <div class="product-item grocery__product">
                              ...
                              <div class="product-thumb theme-bg-2">
                                 <a href="#"><img src="/front/assets/imgs/grocery/product/product7.png"
                                       alt=""></a>
                                 <div class="product-action-item">
                                    <button type="button" class="product-action-btn">
                                       <svg width="20" height="22" viewBox="0 0 20 22" fill="none"
                              ...
                              <div class="product-content">
                                 <h4 class="product-title"><a href="#">Fresh Orange</a>
                                 </h4>
                                 <div class="user-rating mb-1">
                                    <i class="far fa-star"></i>
                                    <i class="far fa-star"></i>
                        ...
                        <div class="col-xxl-3 col-lg-3 col-md-4 col-sm-6 col-6">
                           <div class="product-item grocery__product">
                              <div class="product-thumb theme-bg-2">
                                 <a href="#"><img src="/front/assets/imgs/grocery/product/product8.png"
                                       alt=""></a>
                                 <div class="product-action-item">
                                    <button type="button" class="product-action-btn">
                                       <svg width="20" height="22" viewBox="0 0 20 22" fill="none"
                              ...
                              <div class="product-content">
                                 <h4 class="product-title"><a href="#">Read apple</a></h4>
                                 <div class="user-rating mb-1">
                                    <i class="far fa-star"></i>
                                    <i class="far fa-star"></i>
                                    <i class="far fa-star"></i>
      ...
      <section class="grocery-off">
         <div class="container">
            <div class="row g-4">
               <div class="col-lg-5">
                  <a href="#" class="grocery-off__item h-100 bg-image d-block"
            ...
            <div class="row g-4">
               <div class="col-xl-4 col-lg-6 col-md-6">
                  <div class="grocery-seller__item">
                     <div class="fs-image">
                        <img src="/front/assets/imgs/grocery/product/fs-01.png" alt="">
                     </div>
                     <div class="fs-content">
                        <h5><a href="#" class="text-capitalize">Organic Avocado</a></h5>
                        <span>USD 66.00</span>
                        <div class="fs-rating">
                           <i class="far fa-star"></i>
                           <i class="far fa-star"></i>
               ...
               <div class="col-xl-4 col-lg-6 col-md-6">
                  <div class="grocery-seller__item">
                     <div class="fs-image">
                        <img src="/front/assets/imgs/grocery/product/fs-02.png" alt="">
                     </div>
                     <div class="fs-content">
                        <h5><a href="#" class="text-capitalize">Cheddar Fries</a></h5>
                        <span>USD 66.00</span>
                        <div class="fs-rating">
                           <i class="far fa-star"></i>
                           <i class="far fa-star"></i>
               ...
               <div class="col-xl-4 col-lg-6 col-md-6">
                  <div class="grocery-seller__item">
                     <div class="fs-image">
                        <img src="/front/assets/imgs/grocery/product/fs-03.png" alt="">
                     </div>
                     <div class="fs-content">
                        <h5><a href="#" class="text-capitalize">Alexander roll ..</a></h5>
                        <span>USD 66.00</span>
                        <div class="fs-rating">
                           <i class="far fa-star"></i>
                           <i class="far fa-star"></i>
               ...
               <div class="col-xl-4 col-lg-6 col-md-6">
                  <div class="grocery-seller__item">
                     <div class="fs-image">
                        <img src="/front/assets/imgs/grocery/product/fs-04.png" alt="">
                     </div>
                     <div class="fs-content">
                        <h5><a href="#" class="text-capitalize">Broccoli Farms</a></h5>
                        <span>USD 66.00</span>
                        <div class="fs-rating">
                           <i class="far fa-star"></i>
                           <i class="far fa-star"></i>
               ...
               <div class="col-xl-4 col-lg-6 col-md-6">
                  <div class="grocery-seller__item">
                     <div class="fs-image">
                        <img src="/front/assets/imgs/grocery/product/fs-05.png" alt="">
                     </div>
                     <div class="fs-content">
                        <h5><a href="#" class="text-capitalize">Cheddar Fries</a></h5>
                        <span>USD 66.00</span>
               ...
               <div class="col-xl-4 col-lg-6 col-md-6">
                  <div class="grocery-seller__item">
                     <div class="fs-image">
                        <img src="/front/assets/imgs/grocery/product/fs-06.png" alt="">
                     </div>
                     <div class="fs-content">
                        <h5><a href="#" class="text-capitalize">Broccoli Organic</a></h5>
                        <span>USD 66.00</span>
                        <div class="fs-rating">
                           <i class="far fa-star"></i>
                           <i class="far fa-star"></i>
               ...
               <div class="col-xl-4 col-lg-6 col-md-6">
                  <div class="grocery-seller__item">
                     <div class="fs-image">
                        <img src="/front/assets/imgs/grocery/product/fs-07.png" alt="">
                     </div>
                     <div class="fs-content">
                        <h5><a href="#" class="text-capitalize">Broccoli Farms</a></h5>
                        <span>USD 66.00</span>
               ...
               <div class="col-xl-4 col-lg-6 col-md-6">
                  <div class="grocery-seller__item">
                     <div class="fs-image">
                        <img src="/front/assets/imgs/grocery/product/fs-08.png" alt="">
                     </div>
                     <div class="fs-content">
                        <h5><a href="#" class="text-capitalize">Cheddar Fries</a></h5>
                        <span>USD 66.00</span>
               ...
               <div class="col-xl-4 col-lg-6 col-md-6">
                  <div class="grocery-seller__item">
                     <div class="fs-image">
                        <img src="/front/assets/imgs/grocery/product/fs-09.png" alt="">
                     </div>
                     <div class="fs-content">
                        <h5><a href="#" class="text-capitalize">Broccoli Organic</a></h5>
                        <span>USD 66.00</span>
                        ...
                        <div class="swiper-wrapper">
                           <div class="swiper-slide">
                              <div class="product-item grocery__product">
                                 ...
                                 <div class="product-content">
                                    <h4 class="product-title"><a href="#">Alexander roll Arm
                                          sofa</a></h4>
                           ...
                           <div class="swiper-slide">
                              <div class="product-item grocery__product">
                                 ...
                                 <div class="product-content">
                                    <h4 class="product-title"><a href="#">Brasslegged
                                          Armchair</a></h4>
                                    <div class="user-rating">
                                       <i class="fal fa-star"></i>
                                       <i class="fal fa-star"></i>
                           ...
                           <div class="swiper-slide">
                              <div class="product-item grocery__product">
                                 ...
                                 <div class="product-content">
                                    <h4 class="product-title"><a href="#">leather orange chair</a>
                                    </h4>
                                    <div class="user-rating">
                                       <i class="fal fa-star"></i>
                                       <i class="fal fa-star"></i>
                     ...
                     <div class="support-content">
                        ...
                        <div class="mobile__app-download">
                           <a class="app__download" href="#">
                              <img src="/front/assets/imgs/app/play-store.png" alt="image not found">
                           </a>
                           <a class="app__download" href="#">
                              <img src="/front/assets/imgs/app/apple-store.png" alt="image not found">
                           </a>
                        </div>
                     </div>
                  </div>
...
<footer class="footer-bg">
               ...
               <div class="footer-grid-3">
                  <div class="footer-widget-4">
                     <div class="footer-logo mb-35">
                        <a href="#"><img src="/front/assets/imgs/logo.png"
            ...
            <div class="footer-copyright-wrapper">
               <div class="footer-copyright-text">
                  <p class="mb-0">© All Copyright 2024 by <a target="_blank" class="grocery-clr-hover"
                        href="#">Halal And Healthy</a></p>
               </div>
               <!-- <div class="footer-payment d-flex align-items-center gap-2">
                  <div class="footer-payment-item mb-0">
                     <div class="footer-payment-thumb">
                        <img src="/front/assets/imgs/icons/payoneer.png" alt="">
                     </div>
                  </div>
                  <div class="footer-payment-item mb-0">
                     <div class="footer-payment-thumb">
                        <img src="/front/assets/imgs/icons/maser.png" alt="">
                     </div>
                  </div>
                  <div class="footer-payment-item">
                     <div class="footer-payment-thumb">
                        <img src="/front/assets/imgs/icons/paypal.png" alt="">
                     </div>
                  </div>
               </div> -->
   ...
   <script src="/front/assets/js/beforeafter.jquery-1.0.0.min.js"></script>
